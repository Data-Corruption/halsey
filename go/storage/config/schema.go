...
var SchemaRecord = map[string]schema{
	"v1.2.0": {
		...
		"expandInstagram":   &value[bool]{true},           // whether Instagram expansion is enabled
		"expandReddit":      &value[bool]{true},           // whether Reddit expansion is enabled
		"expandTwitter":     &value[bool]{true},           // whether Twitter expansion is enabled
		"expandYouTube":     &value[bool]{true},           // whether YouTube expansion is enabled
